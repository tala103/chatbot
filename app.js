...
// ملاحظة: الاسم "handler.php" مُستخدم بدل "chat.php" لأن بعض الاستضافات
// المجانية (مثل InfinityFree) تحجب أسماء ملفات معينة زي "chat.php" أمنيًا
const BACKEND_URL = "api/handler.php";
